...
<Steps>
  <Step title="Lock Collateral" icon="lock" titleSize="h3">
  ...
  <Step title="Check Available Credit" icon="chart-line" titleSize="h3">
  ...
  <Step title="Draw Credit" icon="credit-card" titleSize="h3">
  ...
  <Step title="Repayment" icon="money-bill-wave" titleSize="h3">
