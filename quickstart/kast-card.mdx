...
<Steps>
  <Step title="Lock Collateral & Activate Card" icon="lock" titleSize="h3">
  ...
  <Step title="Set Spending Limit from Credit Capacity" icon="chart-line" titleSize="h3">
    ...
    See [Credit Engine](/stash-credit-v2/credit-engine) for how health factor, LTVs, and liquidation thresholds work.
  </Step>

  <Step title="Draw Credit on Card Swipe" icon="credit-card" titleSize="h3">
  ...
  <Step title="Monthly Repayment" icon="money-bill-wave" titleSize="h3">
  ...
  <Step title="Unlock Collateral" icon="lock-open" titleSize="h3">
...
<AccordionGroup>
  <Accordion title="Card Tiers & Credit Limits" icon="credit-card">
    Kast offers Standard (2% rewards), Premium (5%), and Luxe (8%) tiers. Map Sprinter Credit configurations to each tier — higher tiers could have higher LTV ratios or access to more collateral types via the [Policy Engine](/stash-credit-v2/policy-engine).
  </Accordion>
...
<CardGroup cols={3}>
  ...
  <Card title="Policy Engine" icon="sliders" href="/stash-credit-v2/policy-engine">
