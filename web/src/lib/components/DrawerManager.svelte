...
<Drawer>
	<div
		class="w-full h-full bg-white rounded-xl shadow border border-gray-300 flex-col justify-start items-start inline-flex"
	>
		<div class="w-full h-16 p-5 bg-white justify-start items-center gap-3 inline-flex">
