<div class="w-[1012px] h-full py-[15px] flex-col justify-start items-center gap-2.5 inline-flex">
    <div class="self-stretch h-[152px] px-[22px] py-[23px] bg-gray-200 rounded-xl flex-col justify-start items-center gap-[34px] flex">
        <div class="self-stretch justify-start items-start gap-2.5 inline-flex">
            <div class="text-black text-xl font-medium font-['Inter'] leading-7">Hello, 0x123a, 456b.</div>
        </div>
        <div class="self-stretch justify-end items-start gap-2 inline-flex">
            <div class="p-2.5 bg-black rounded-full justify-center items-center gap-2 flex">
                <div class="text-white text-base font-medium font-['Inter'] leading-normal">Send & Receive</div>
            </div>
        </div>
    </div>
</div>