                ...
                <tr class="pt-2">
                    <td class="flex items-center gap-2 py-2">
                        ...
                        <div class="flex">
                            ...
                            <div class="px-2 ml-2 py-0.5 bg-zinc-200 rounded text-slate-700 text-sm">6.4%</div>
                        </div>
                    </td>
                    <td class="text-slate-700 text-base text-left">{fromWei(token.total, token.decimals)} {token.symbol}</td>
                    <td class="text-slate-700 text-base"><Facepile balances={token.balances} networks={data.raw.networks} /></td>
                </tr>
                {/each}
                </tbody>
            </table>
