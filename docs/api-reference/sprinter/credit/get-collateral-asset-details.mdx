...
<Info>
The `chain` parameter uses **CAIP-2 format**: `eip155:<chainId>`. For example, `eip155:8453` for Base or `eip155:1` for Ethereum. See [Supported Chains](/stash-credit-v2/overview#supported-chains) for the full list.
</Info>
