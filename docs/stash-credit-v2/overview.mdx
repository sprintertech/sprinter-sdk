...
<Tip>
  You can always fetch the current list of supported chains and their collateral
  configurations from the [`GET
  /credit/protocol`](/api-reference/sprinter/credit/get-credit-protocol-configuration)
  endpoint.
</Tip>
