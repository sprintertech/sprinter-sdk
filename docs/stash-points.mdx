---
title: "Stash Points"
description: "Earn Stash points by participating in the Sprinter ecosystem through liquidity provision"
---
...
- **Solver fees**
- **Strategy fees**
- **Multi-dimensional passive yield**
- **Stash points**
- **Rewards** (post TGE)

<Note>
Watch the Stash walkthrough video at [app.sprinter.tech](https://app.sprinter.tech/).
</Note>
