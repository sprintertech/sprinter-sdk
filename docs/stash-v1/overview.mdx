...
description: "Sprinter Stash is a credit-based liquidity protocol for crosschain solvers and liquidity providers"
---

<Tip>
Ready to Stash? Check out [Stash Points](/stash-points) on how to provide capital, earn yield and win Stash Points.
</Tip>
...
Sprinter Stash handles crosschain liquidity fills. Revenue is generated from the spread between the amount the user deposited on source and the amount provided on the destination.
...
- As a Liquidity Provider: check out [Stash Points](/stash-points)
- For DeFi: check out the [Stash API Integration Guide](/stash-v1/integration-guide)
