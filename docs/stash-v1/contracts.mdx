...
description: "Smart contract addresses and details for Sprinter Stash liquidity hub, mining, and pools"
---

# Sprinter Stash

Central to Sprinter Stash are the [**Sprinter Liquidity Hub**](#liquidity-hub), [**Liquidity Mining**](#liquidity-mining-contract) and [**Stash Pools**](#liquidity-pools) smart contracts which manages and distributes liquidity.
...
<Note>
  MPC signing happens off-chain but is fully verifiable and auditable via
  Sprinter's on-chain replay logs and relay receipts.
</Note>
