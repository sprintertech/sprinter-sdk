...
<div style={{ display: "flex", justifyContent: "center" }}>
  ```mermaid flowchart TD A[User locks collateral via Sprinter] --> B[Credit
  line activated on Kast] B --> C[Visa card swipe] C --> D[Kast backend draws
  USDC via Sprinter API] D --> E[Third National settles with Visa] E --> F[User
  repays at end of billing cycle] ```
</div>
...
<CardGroup cols={3}>
  ...
  <Card
    title="Policy Engine"
    icon="sliders"
    href="/stash-credit-v2/policy-engine"
  >
