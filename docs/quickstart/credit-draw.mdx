...
<Info>
This example demonstrates the core credit draw flow. For a complete card issuer integration — including KYC, card issuance, and deposit address routing — see the [Card Issuer Integration](/quickstart/card-issuer-integration) quickstart.
</Info>
...
<Card title="Credit Draw Demo" icon="play" href="https://github.com/sprintertech/sprinter-sdk/tree/main/docs/demo">
