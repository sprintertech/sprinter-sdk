...
<Info>
  This example uses [Rain](https://www.rain.xyz) as the card issuer. Adapt
  signature validation and response format for your card program.
</Info>
...
| --------------------- | ------------------------------------------------------------------------ |
| `SPRINTER_API_KEY`    | Sprinter Credit API key ([app.sprinter.tech](https://app.sprinter.tech)) |
