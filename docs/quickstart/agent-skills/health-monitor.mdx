...
- **Repays debt** before the billing cycle ends to avoid the [15% overdue APR](/stash-credit-v2/credit-engine#fees)
...
<AccordionGroup>
  ...
  <Accordion title="Health Factor Threshold" icon="heart-pulse">
    Default: 1.3. The agent tops up collateral when health factor drops below this. See [Risk Management](/stash-credit-v2/risk-management) for liquidation thresholds — positions below 1.0 are liquidatable.
  </Accordion>
